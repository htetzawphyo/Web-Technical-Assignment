<template>
  ...
  <div class="p-6 mt-12 md:ml-64">
      ...
      <div v-if="getItem">
        <DataTable :data="getItem" :columns="columns" :options="options" class="display" width="100%">
...
<script setup>
    ...
    const { getItem } = storeToRefs(itemStore);
    ...
    // onMounted(async () => {
    //   await itemStore.indexItem();
    //   data.value = getItem.value;
    // });
